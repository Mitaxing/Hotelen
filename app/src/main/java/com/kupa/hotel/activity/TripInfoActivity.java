...
import com.kupa.hotel.adapter.ViewInfoAdapter;
...
public class TripInfoActivity extends BaseActivity implements View.OnFocusChangeListener {
    ...
    private int[] views = {R.mipmap.trip_info_erhai,  R.mipmap.trip_info_hongtudi,R.mipmap.trip_info_gucheng, R.mipmap.trip_info_luguhu,
            R.mipmap.trip_info_meilixueshan, R.mipmap.trip_info_yulongxueshan};
