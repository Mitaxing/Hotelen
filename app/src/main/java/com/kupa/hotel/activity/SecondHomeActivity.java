...
import com.kupa.hotel.adapter.RecyclerAdapter;
import com.kupa.hotel.adapter.RecyclerServerAdapter;
...
public class SecondHomeActivity extends BaseActivity implements View.OnFocusChangeListener, RecyclerServerAdapter.ViewHolder.OnItemClickListener {
    ...
    private Class[] clazz = {MovieHomeActivity.class, MovieHomeActivity.class, MovieHomeActivity.class, MovieHomeActivity.class, MovieHomeActivity.class,};
