...
import static com.kupa.hotel.utils.InitMovies.initLocalMovies;
import static com.kupa.hotel.utils.InitMovies.initNetWorkMovies;
...
public class LoadMovies {
    ...
    public static List<Movie> getNetWorkMovie(final List<Movie> item) {
        ...
        try {
            SmbFile smbFile = new SmbFile(com.kupa.hotel.contacts.Contacts.DEFAULT_SMB_PATH);
