...
import com.kupa.hotel.cache.BitmapMemoryCache;
import com.kupa.hotel.utils.DrawUtils;
 ...
 */
public class ReflectItemViewLayout extends FrameLayout {
    ...
    public ReflectItemViewLayout(Context context) {
        this(context, null, 0);
    }

    public ReflectItemViewLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ReflectItemViewLayout(Context context, AttributeSet attrs, int defStyle) {
