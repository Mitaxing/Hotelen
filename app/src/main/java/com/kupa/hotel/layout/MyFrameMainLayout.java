...
import com.kupa.hotel.bridge.WidgetTvViewBring;
 ...
 *
 */
public class MyFrameMainLayout extends FrameLayout {

	public MyFrameMainLayout(Context context) {
		super(context);
		init(context);
	}

	public MyFrameMainLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
