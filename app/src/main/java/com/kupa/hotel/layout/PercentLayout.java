...
/**
 * Created by HM on 2017/3/14 17:47
 */
...
public class PercentLayout {
    ...
    public PercentLayout(ViewGroup host) {
        mHost = host;
        getScreenSize();
    }
    ...
    private void invokeMethod(String methodName, int widthHint, int heightHint, View view,
                              @SuppressWarnings("rawtypes") Class clazz, PercentLayoutInfo.PercentVal percentVal)
     ...
     * you previously called {@link PercentLayout#adjustChildren(int, int)}.
     */
    ...
    public static class PercentLayoutInfo {
         ...
         * previously called {@link PercentLayoutInfo#fillMarginLayoutParams}.
         */
