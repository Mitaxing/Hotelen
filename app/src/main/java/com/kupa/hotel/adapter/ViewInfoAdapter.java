...
public class ViewInfoAdapter extends RecyclerView.Adapter<ViewInfoAdapter.ViewInfoViewHolder> {
    ...
    private int[] views;
    private int[] introduce = {R.string.view1, R.string.view2, R.string.view3, R.string.view4, R.string.view5, R.string.view6};
    private String[] postions = {"assets://trip_info_erhai.jpg","assets://trip_info_hongtudi.jpg","assets://trip_info_gucheng.jpg","assets://trip_info_luguhu.jpg"
    ,"assets://trip_info_meilixueshan.jpg","assets://trip_info_yulongxueshan.jpg"};
