...
public class ViewsAdapter extends RecyclerView.Adapter<ViewsAdapter.ViewsViewHolder> {
    ...
    private int[] views = {R.mipmap.trip_erhai, R.mipmap.trip_hongtudi, R.mipmap.trip_lijianggucheng, R.mipmap.trip_luguhu,
            R.mipmap.trip_meilixueshan, R.mipmap.trip_yulongxueshan};
    private String[] names = {"Erhai", "East sichuan red land", "Old Town of Lijiang", "Lugu Lake", "Meri Snow Mountain", "Jade Dragon Snow Mountain"};
